...
2. In a second terminal window, start a new instance of the example with the following command:
   ...
   ```sh
   cargo run --bin ping --release /ip4/127.0.0.1/tcp/44389/p2p/2958bs....
   ```
...
The ping example demonstrates the basic usage of **rnet** to create a simple p2p network and implement a ping protocol.
By running multiple nodes and observing the ping behavior, users can gain insights into how **rnet** facilitates communication and interaction between peers.
